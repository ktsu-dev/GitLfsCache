...
- [minor] Split the container host into GitLfsCache.Service ([@Matthew Edmondson](https://github.com/Matthew Edmondson))
- [patch] Set PackageProjectUrl explicitly so packaging and container publish work ([@Matthew Edmondson](https://github.com/Matthew Edmondson))
